...
-- Script date 29/11/2013 14:07:56
...
INSERT INTO tb_paciente VALUES 
  (7, 'jorge luis', 'torres', 'colan', 'C', 20, 'estudiante', 'Lima', 'Huaral', 'la huaquilla', 996514952, 'A');
...
INSERT INTO tb_persona VALUES 
  ...
  (15, 'luis javier', 'chavez', 'maita', 'luis javier chavez', '1992-01-22', 'Urb. Las Brisas', 980163759, '12345678', 1, 1),
...
INSERT INTO tb_diagnostico VALUES 
  (4, '2013-11-14', '3 meses', '', 'Dolor de estomago muy seguido', '72', '60/80', '22', '37', 60, '', '', '', '', '', '', '', '', 'medicacio', 'medicacio', 'medicacio', 'medicacio', 'medicacion', 'medicacion', 'medicacion', 'medicacion', 'ninguno', NULL, 3),
  (5, '2013-11-14', '3 meses', '', 'Dolor de estomago muy seguido', '72', '60/80', '22', '37', 60, '', '', '', '', '', '', '', '', 'medicacio', 'medicacio', 'medicacio', 'medicacio', 'medicacion', 'medicacion', 'medicacion', 'medicacion', 'ninguno', NULL, 3),
  (18, '2013-11-21', 'gggg', 'gggg', 'ggg', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'gggg', NULL, 3),
  (19, '2013-11-07', 'hhhh', 'hhh', 'hhh', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'hhhh', NULL, 3),
  (20, '2013-11-01', 'fff', 'ff', 'ff', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'fff', NULL, 3);
