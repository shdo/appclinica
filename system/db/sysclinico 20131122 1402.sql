...
-- Script date 22/11/2013 14:02:28
...
INSERT INTO tb_paciente VALUES 
  (1, 'jorge luis', 'torres', 'colan', 'S', 20, 'estudiante', 'Lima', 'Huaral', 'la huaquilla', 996514952, 'A'),
  (2, 'Jorge Manuel', 'sanchez', 'carrion', 'V', 34, 'ingeniero', 'Lima', 'Huacho', 'huacho', 546564, 'D'),
  (3, 'jeair alberto', 'cangana', 'retuerto', 'S', 21, 'estudiante', 'Chancay', 'Chancay', 'chancay', 980163759, 'A');
